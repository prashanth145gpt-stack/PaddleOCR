	...
	<div class="content">
		...
		<div class="alert">
			...
			<div class="content">
				...
				<p>For information on Red Hat Enterprise Linux, please visit the <a href="http://www.redhat.com/">Red
						Hat, Inc. website</a>. The documentation for Red Hat Enterprise Linux is <a
						href="http://www.redhat.com/docs/manuals/enterprise/">available on the Red Hat, Inc.
						website</a>.</p>
...
download https://paddleocr.bj.bcebos.com/PP-OCRv4/english/en_PP-OCRv4_rec_infer.tar to /app/ocr_models/rec/en_PP-OCRv3_rec_infer/en_PP-OCRv4_rec_infer.tar
Traceback (most recent call last):
  File "/usr/local/lib/python3.10/site-packages/urllib3/connectionpool.py", line 773, in urlopen
    self._prepare_proxy(conn)
  File "/usr/local/lib/python3.10/site-packages/urllib3/connectionpool.py", line 1042, in _prepare_proxy
...
Traceback (most recent call last):
  ...
  File "/app/app.py", line 30, in <module>
    ocr = PaddleOCR(
  File "/usr/local/lib/python3.10/site-packages/paddleocr/paddleocr.py", line 600, in __init__
